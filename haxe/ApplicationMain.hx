...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("lets-play-the-shining", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("lets-play-the-shining", null, 480, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "lets-play-the-shining";
		app.meta["name"] = "Let's Play: The Shining";
