...
class BatState extends FlxState
{
	...
	{		
		...
		stepTimer = new FlxTimer(STEP_TIME,stepBack);
		reachTimer = new FlxTimer(REACH_TIME_MIN + Math.random() * REACH_TIME_RANGE,reach);
		headTimer = new FlxTimer();
